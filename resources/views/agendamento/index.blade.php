<x-app-layout>
    ...
    <div>
        <div class="py-8" x-data="{ statusFilter: '' }">
            ...
            <div class="px-8">
                <select
                    class="py-3 px-4 pr-9 block w-100 border-blue-500 rounded-full text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
                                    ...
                                    <template x-if="editMode">
                                        <form action="{{ route('agenda.update', $agenda) }}" method="POST">
                                            ...
                                            <input
                                                ...
                                                type="text" name="data" value="{{ $agenda->data }}" />
                                            <button>Salvar</button>
                                        </form>
                                    </template>
                                </div>
                                <template x-if="editMode">
                                    <div class="cursor-pointer hover:bg-gray-700 hover:text-white"
                ...
                <div class="flex flex-col gap-2">
                    @foreach (\App\Models\Agenda::all() as $agenda)
                        @if ($agenda->usuarioDoar_id == auth()->id())
                            <div x-show="statusFilter == '' || statusFilter == '{{ $agenda->status }}'"
                                class="" x-data="{ editMode: false }">
