                ...
                @if ($objeto->user_id == auth()->id())
                    <div x-data="{ editMode: false, showDelete: false }">
                        ...
                        <div x-show="showDelete"
                            ...
                            <div class="md:w-96 bg-gray-800 p-4 absolute left-1/3 right-1/3 top-1/4 z-50">
                                <form class="py-2 w-full text-center" action="{{ route('objetos.destroy', $objeto) }}"
                                    method="POST">
                                    @csrf
                                    @method('DELETE')
                                    ...
                                    <p class="mb-4 text-gray-500 dark:text-gray-300">Tem certeza que deseja excluir este
                                        objeto?</p>
                                    <button @click="showDelete = true"
                                ...
                                <button
                                    class="w-full py-2 px-3 text-sm font-medium text-gray-500 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-primary-300 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600"
