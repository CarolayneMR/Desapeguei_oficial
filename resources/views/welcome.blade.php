                ...
                <div class="py-6 px-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 w-full">
                    ...
                    @if ($objeto->id < 5) <span>
                        <div class="max-w-sm py-2 bg-white border border-gray-200 rounded-lg shadow hover:-translate-y-1 hover:scale-105 duration-300">
                            ...
                            <img style="height: 200px; width:200px" class="md:w-full pt-2" src="/img/objetos/{{ $objeto->imagem }}" alt="Imagem do objeto" />
                            </a>
                            <div class="p-5">
                    ...
                    <div class="pl-8">
                        ...
                        <div class="items-center content-center ">
                            ...
                            <div class="flex content-center p-1 pl-3 m-2">
                                ...
                                <a class="font-bold pl-4" href="https://www.linkedin.com/" target="_blank">Eduardo</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pl-8">
                        ...
                        <div class="items-center content-center ">
                            ...
                            <div class="flex content-center p-1 pl-3 m-2">
                                ...
                                <a class="font-bold pl-4" href="https://www.linkedin.com/" target="_blank">Ian</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pl-8">
                        ...
                        <div class="items-center content-center ">
                            ...
                            <div class="flex content-center p-1 pl-3 m-2">
                                ...
                                <a class="font-bold pl-4" href="https://www.linkedin.com/" target="_blank">Suelen</a>
                            </div>
                        </div>
                    </div>
